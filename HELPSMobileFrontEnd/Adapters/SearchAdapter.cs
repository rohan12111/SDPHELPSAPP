...
{
	public class SearchAdapter : BaseAdapter<WorkshopSets>
	{
		Activity context = null;
		IList<WorkshopSets> WorkShops = new List<WorkshopSets>();

		public SearchAdapter(Activity context, IList<WorkshopSets> workshops) : base ()
		{
		...
		public override Android.Views.View GetView (int position, Android.Views.View convertView, Android.Views.ViewGroup parent)
		{
			...
			tvWorkshops.SetText (item.id, TextView.BufferType.Normal);
